...
const content = new CatSectionContent({
    ...
    elems: [
{
    over:  {'en': '13.11.2020 - 15.11.2020',
            'pl': '13.11.2020 - 15.11.2020',
    },
    title: {'en': 'AI HACKATHON skyhacks 2020',
            'pl': 'AI HACKATHON skyhacks 2020',
    },
    sub:   {'en': 'Competition, 4-person team',
            'pl': 'Konkurs, 4-osobowy zespół',
    },
    desc:  {'en': '3rd place, 4000zł price won',
            'pl': '3-cie miejsce, 4000zł wygranej',
    },
},
{
    ...
    desc:  {'en': 'Certificate of completion',
