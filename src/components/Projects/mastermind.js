...
const content = new ProjectContent({
    title: {
        'en': "Master Mind videogame on a FPGA",
    ...
    imgs: [
        { src:  '/imgs/mastermind_hardware.png',
          desc: {
            'en': 'FPGA Developement board with connected controler',
    ...
    content_short: {
        'en': /*html*/`
        The aim of the thesis was to <b>design and create a system implementing the logic game "Master Mind" based on the FPGA system.</b>
        The device is controlled using <b>buttons on the breadboard</b>, and the image is displayed using <b>VGA or HDMI</b>.
        `,
        'pl': /*html*/`
        Celem pracy było <b>zaprojektowanie i wykonanie układu realizującego grę logiczną "Mistrz intelektu" (ang. "Master Mind") w oparciu o układ FPGA.</b>
    ...
    content: {
        ...
        Since the entire logic <b>was designed in hardware</b>, it was not possible to simply define a sequence of instructions to be executed.
        ...
        Control is via buttons on a separate <b>contact board connected to the device</b>.
        ...
        <br>
        <br>
        Grę stworzono w całości w języku opisu sprzętu <b>SystemVerilog</b>. Takie podejście wymaga innego myślenia, niż jak w przypadku programowania w zwyczajnym języku programowanie (jak np. C++).
        Ponieważ całą logikę <b>zaprojektowano sprzętowo</b> (na hardware'że), nie można było po prostu zdefiniować sekwencji instrukcji do wykonania.
        Dane przetwarzane są w sposób <b>znacznie bardziej współbierzny, niż gdyby zastosowano CPU</b>, co wymagało trochę <b>kreatywności, szczególnie przy implementacji logiki wyliczającej podpowiedzi</b>.
        <br>
        <br>
